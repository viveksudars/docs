...
<AccordionGroup>
  <Accordion title="Contacts Engaged">
    **Definition**: 
    Represents the total number of visitors, including anonymous visitors, who have interacted with a specific marketing tactic or channel. This is a sum of existing visitors, and any new visitors that interacted with your marketing for the first time in the time range.

    > **Importance**:
    > Measures total engagement across all visitors for a given marketing tactic. 
    >
    > **Use Case**:
    > Useful for evaluating the reach of a marketing tactic or channel. For instance, if a new blog post reaches 5,000 visitors, you can assess the total reach of that post within the time period for new and existing contacts.
  </Accordion>

  <Accordion title="Accounts Engaged">
    **Definition**: 
    The number of accounts that interacted with a marketing tactic or channel.
  ...
  <Accordion title="Influenced Revenue">
    **Definition**: 
    The influence revenue attributed to each tactic or channel, based on a blend of multiple multi-touch attribution models.
  ...
  <Accordion title="Influenced Pipeline">
    **Definition**: 
    The influenced pipeline attributed to each tactic or channel, based on a blend of multiple multi-touch attribution models.
